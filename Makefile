...
ffmpeg-movenet:
	cd $(PROJECT_DIR)/ffmpeg_hpe && sudo ./run_experiment_bcc.sh movenet

ffmpeg-alphapose:
	cd $(PROJECT_DIR)/ffmpeg_hpe && sudo ./run_experiment_bcc.sh alphapose

ffmpeg-openpose:
	cd $(PROJECT_DIR)/ffmpeg_hpe && sudo ./run_experiment_bcc.sh openpose

ffmpeg-hrnet:
	cd $(PROJECT_DIR)/ffmpeg_hpe && sudo ./run_experiment_bcc.sh hrnet

ffmpeg-ae1:
	cd $(PROJECT_DIR)/ffmpeg_hpe && sudo ./run_experiment_bcc.sh ae1

ffmpeg-ae2:
	cd $(PROJECT_DIR)/ffmpeg_hpe && sudo ./run_experiment_bcc.sh ae2

ffmpeg-ae3:
	cd $(PROJECT_DIR)/ffmpeg_hpe && sudo ./run_experiment_bcc.sh ae3
